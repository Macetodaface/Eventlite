...
urlpatterns = [
    ...
    url(r'^seat-layout/(?P<id>.+)', eventViews.get_seat_layout, name = 'seatLayout'), 
    url(r'^user-image/(?P<id>.+)', eventViews.get_user_image, name = 'userimage'), 
    ...
    url(r'^logout', accountViews.logout_user, name='logout'), 
